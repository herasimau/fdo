...
class MailViewController: BaseViewController<MailPresenterProtocol> {
...
extension MailViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    private func prepareTableView() {
        tableView.register(UINib(nibName: "MailPageItemCell", bundle: nil), forCellReuseIdentifier: "cell")
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        return presenter.numOfMailItems
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        presenter.openMailPreviewController(at: indexPath.section)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? MailPageItemCell else { return UITableViewCell() }
        cell.set(viewModel: presenter.viewModelForMailPageItem(at: indexPath.section))
